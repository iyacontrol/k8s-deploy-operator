...
import (
	...
	versioned "k8s.io/k8s-deploy-operator/pkg/client/clientset/versioned"
	internalinterfaces "k8s.io/k8s-deploy-operator/pkg/client/informers/externalversions/internalinterfaces"
	v1 "k8s.io/k8s-deploy-operator/pkg/client/listers/k8sdeployoperator/v1"
)
